...
select_stmt : KW_SELECT obj_expr KW_FROM STRING KW_WHERE where_expr | KW_SELECT obj_expr KW_FROM STRING ;
obj_expr : vs_info | KW_COUNT vs_info | KW_EXISTS vs_info | KW_DEGREE vs_info | KW_DISTANCE vs_info | KW_COUNT_ISOLATED ;
vs_info : LBR IDENT COMMA IDENT RBR | LBR IDENT RBR ;
where_expr : LBR v_expr RBR OP_MINUS pattern OP_MINUS OP_GR LBR v_expr RBR | LBR v_expr RBR | LBR v_expr COMMA v_expr RBR ;
